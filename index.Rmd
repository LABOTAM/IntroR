...
Ricardo (ricardoperdiz.com) é formado em Ciências Biológicas pela Universidade Estadual de Santa Cruz (UESC), mestre em Botânica pela Universidade Estadual de Feira de Santana (UEFS) e doutor em Ciências Biológicas (Botânica) pelo INPA.
...
Pescar também é apreciado, apesar de o peixe não ser pescado, somente admirado!  
...
Acesse a [página do repositório](https://github.com/LABOTAM/LABOTAM.github.io) contendo os código fonte deste livro (Fig. \@ref(fig:repo)).
