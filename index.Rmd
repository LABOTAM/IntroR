...
* **Capítulo \@ref(mat-dframe)** XXX.
* **Capítulo \@ref(lista-objcompl)** XXX.
* **Capítulo \@ref(func-graf)** XXX.
* **Capítulo \@ref(iter-cflux)** XXX.
* **Capítulo \@ref(sumar-dados)** XXX.
* **Capítulo \@ref(manip-txt-arq-pasta)** XXX.
* **Capítulo \@ref(amost-aleat)** XXX.
* **Capítulo \@ref(extr-dados)** XXX.
* **Capítulo \@ref(mat-sup)** XXX.
...
Busque um botão de cor **verde** chamado *Code* (Fig. \@ref(fig:baixa_repo)).
