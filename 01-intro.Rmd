...
```{r rpadrao, out.width="100%", fig.cap = ' Imagem de uma sessão do R para Mac OSX com um janela de script aberta além do console.', eval = TRUE, echo = FALSE}
...
```{r rstudio, out.width="100%", fig.cap = ' Imagem de uma sessão do R studio com três painéis abertos.', eval = TRUE, echo = FALSE}
