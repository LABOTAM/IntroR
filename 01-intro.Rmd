...
```{r rpadrao, out.width="120%", fig.cap = ' Imagem de uma sessão do R para Mac OSX com um janela de script aberta além do console.', eval = TRUE, echo = FALSE}
...
```{r rstudio, out.width="80%", fig.cap = ' Imagem de uma sessão do R studio com três painéis abertos.', eval = TRUE, echo = FALSE}
...
Nós poderíoamos ter chamado `objum` de qualquer coisa (sem espaços em branco):
