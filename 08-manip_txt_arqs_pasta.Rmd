...
Note que há espaços em branco no início e no final do texto.
Podemos removê-los usando a função `trimws()`:
...
(3) Pacote de R [fs](https://github.com/r-lib/fs) - Um pacote que agrupa funções para manipulações de arquivos e pastas, e que apresenta algumas melhoras sobre o conjunto de funções do pacote base do R. Além disso, há alguns tutoriais disponíveis.
