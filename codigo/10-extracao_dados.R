...
#' 
#' Vamos utilizar dados de exemplo para testar a função. Baixe o arquivo presente neste endereço (http://www.botanicaamazonica.wiki.br/labotam/lib/exe/fetch.php?media=analises:baixandoespecimenes:pegados_dados_exemplo.csv).
