...
#' 
#' ## O que é o Tidyverse?^[Texto publicado originalmente no blog de R.O.Perdiz (https://ricardoperdiz.com/2020/04/08/tidyverse/)]
#' 
...
#' Caso queiram ver manipulações mais complexas em tabelas utilizando as ferramentas do tidyverse, convido-os a checarem estas duas postagens: [importando e manipulando dados no R](https://ricardoperdiz.com/2020/03/06/obtendo-dados-e-plotando-mapas-no-r-versao-3/), e um [tutorial para gerar o mapa de distribuição de Macrolobium aracaense Farroñay](https://ricardoperdiz.com/2019/09/01/mapa-macrolobium/).  
#' 
#' 
