...
#' 
#' ## Junção de tabelas utilizando funções^[Texto publicado originalmente no blog de R.O.Perdiz (https://ricardoperdiz.com/2020/04/23/juncao-tbl/)]
#' 
...
#' * Resolva o exercício [103.06 Acrescentando dados](http://www.lage.ib.usp.br/notar/exercicio.php?exerc=24).
#' * Resolva o exercício [103.8 De vetor a data.frame ordenado](http://www.lage.ib.usp.br/notar/exercicio.php?exerc=35).
#' 
